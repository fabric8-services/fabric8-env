...
Environment service takes care of managing environment.  Swagger API: http://swagger.goa.design/?url=github.com%2Ffabric8-services%2Ffabric8-env%2Fdesign[link, role="external", window="_blank"]
